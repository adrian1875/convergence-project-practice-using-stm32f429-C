...
int main(void)
{
  ...
  Locate(0, 1); // line 1, third column
  DispString("Happy Students");
  Locate(1, 16);  // line 1, 21th column
  DispString("Welcome to Robot World");
  Locate(1, 5);  // line 2, 6th column
  DispString("Nice Day");  
  Locate(1, 16); // line 2, 17th column
  DispString("Have a Good Time !");
  /* Infinite loop */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, GPIO_PIN_5|GPIO_PIN_7|GPIO_PIN_8|GPIO_PIN_10
  ...
  /*Configure GPIO pins : PG5 PG7 PG8 PG10
                           PG11 PG12 */
...
{
  if (GPIO_Pin & (GPIO_PIN_12|GPIO_PIN_13|GPIO_PIN_14|GPIO_PIN_15))
  {
      HAL_GPIO_TogglePin(GPIOF, GPIO_Pin >> 8);		
  }
